...
<link href="${ctx}/static/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
<link href="${ctx}/static/assets/admin/pages/css/login3.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.html">
	<img src="${ctx}/static/assets/admin/layout/img/logo-big.png" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<form class="login-form" action="${ctx}/login" method="post">
		...
		<div class="forget-password">
			<h4>忘记密码 </h4>
			<p>
				 不要担心, 请点击 <a href="javascript:;" id="forget-password">
				帮助 </a>
				重置你的密码。
			</p>
		</div>
		<div class="create-account">
			<p>
				 还没有帐户？&nbsp; <a href="javascript:;" id="register-btn">
				创建一个帐户 </a>
			</p>
		</div>
	</form>
...
<script src="${ctx}/static/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
