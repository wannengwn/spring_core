...
<link href="${ctx}/static/assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
...
<body ng-controller="AppController" class="page-header-fixed page-sidebar-closed-hide-logo page-quick-sidebar-over-content page-on-load" ng-class="{'page-container-bg-solid': settings.layout.pageBodySolid, 'page-sidebar-closed': settings.layout.pageSidebarClosed}">
	...
	<script src="${ctx}/static/assets/global/plugins/angularjs/angular.min.js" type="text/javascript"></script>	
	<script src="${ctx}/static/assets/global/plugins/angularjs/angular-sanitize.min.js" type="text/javascript"></script>
	<script src="${ctx}/static/assets/global/plugins/angularjs/angular-touch.min.js" type="text/javascript"></script>	
	<script src="${ctx}/static/assets/global/plugins/angularjs/plugins/angular-ui-router.min.js" type="text/javascript"></script>
	<script src="${ctx}/static/assets/global/plugins/angularjs/plugins/ocLazyLoad.min.js" type="text/javascript"></script>
	<script src="${ctx}/static/assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js" type="text/javascript"></script>
	<!-- END CORE ANGULARJS PLUGINS -->
	
	<!-- BEGIN APP LEVEL ANGULARJS SCRIPTS -->
	<script src="${ctx}/staticjs/app.js" type="text/javascript"></script>
	<script src="${ctx}/staticjs/directives.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {   
			...
			Metronic.setAssetsPath('${ctx}/static/assets/'); // Set the assets folder path			
		});
	</script>
	<!-- END JAVASCRIPTS -->
</body>
